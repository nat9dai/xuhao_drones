///
/// Auto-generated TCP server for optimizer: xuhao_drones
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != XUHAO_DRONES_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != XUHAO_DRONES_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [xuhao_drones]")
        .version("0.0.0")
        .author("John Smith")
